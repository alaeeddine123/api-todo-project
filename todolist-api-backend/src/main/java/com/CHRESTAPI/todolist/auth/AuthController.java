...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> authenticate(
        ...
        // Use ResponseCookie for more modern cookie handling
        ...
        // Set cookie using response header (more widely supported)
        response.addHeader("Set-Cookie", cookie.toString());

        // Additional debugging
        System.out.println("Cookie Details:");
        System.out.println("Full Cookie String: " + cookie.toString());
        System.out.println("Domain: " + cookie.getDomain());
        System.out.println("Path: " + cookie.getPath());
        System.out.println("Max Age: " + cookie.getMaxAge().getSeconds());
